...
const displayNews = async(newsesData) => {
    ...
    newsesData.forEach(news => {
        ...
        const {title,_id,details,author,total_view, rating, thumbnail_url} = news;
            ...
            <div class="row g-0 align-items-center">
                ...
                <div class="col-md-9">
                    <div class="card-body pb-0">
                        ...
                        <p class="pb-5">${details.length > 300 ? details.slice(0, 300) + '...' : details}</p>


                        <div class="row align-items-center">
                            <div class="col d-flex col-4">
                            
                            <img width="40px" height="40px" src="${author.img}" class="news-author-img rounded-circle"/>
                            ...
                            <span class="fw-bolder"><i class="fa-regular fa-eye"></i> ${total_view ? total_view : 'N/A'}</span>

                            </div>
                            <div class="col">
                          
                            <span class="fw-bolder"><i class="fa-sharp fa-solid fa-star"></i> ${rating.number ? rating.number : 'N/A'}</span>
...
const displayNewsDetails = (newsData) => {
    ...
    <img src="${image_url}" class="img-fluid d-block" alt="...">
        <span>${details.length > 500 ? details.slice(0, 500) + '...' : details}</span>
    </div>
